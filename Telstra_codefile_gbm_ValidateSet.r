...
predknown=predict(gbm_model,newdata=Actual_Validateset,type='raw')
...
pred=predict(gbm_model,newdata=X_test[,feature.namestest],type='raw')
...
write.csv(mysub1,'E:\\AbhinavB\\Kaggle\\Telstra network disruptions\\submission files\\submission2Nov5.csv')
